...
// Get all portfolios
export const getAllPortfolios = async (_req, res) => {
    try {
...
export const createPortfolio = async (req, res) => {
    try {
        const { userId, portfolioUrl, bio, skills, about, projects, experience, education, patentsOrPapers, profileLinks, username, } = req.body;
...
export const updatePortfolio = async (req, res) => {
    try {
        const { userId, portfolioUrl, bio, skills, about, projects, experience, education, patentsOrPapers, profileLinks, published, username, } = req.body;
...
export const togglePublishPortfolio = async (req, res) => {
    try {
        const { userId } = req.params;
        const portfolio = await Portfolio.findOne({ user: userId });
        if (!portfolio) {
...
export const saveProfile = async (req, res) => {
    try {
        const { username, displayName, skills, experience, projects, education, published, portfolioUrl, bio, about, patentsOrPapers, profileLinks, } = req.body;
...
export const getProfile = async (req, res) => {
    try {
        const { userId } = req.params;
        // Fetch the portfolio
        const portfolio = await Portfolio.findOne({ user: userId }).populate("user", "username firstName lastName");
        if (!portfolio) {
...
export const changePortfolioPassword = async (req, res) => {
