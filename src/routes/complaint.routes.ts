...
import { createComplaint, getComplaints, updateComplaint, deleteComplaint, getStudentComplaints, deleteStudentComplaint } from "../controllers/Complaints.controller.js";
...
router.get("/", authorizeAdmin, getComplaints);
